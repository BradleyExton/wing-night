...
/**
 * SCHLONIC re-runs the same sim on three machines — the tablet plays it, the server referees it,
 * the display mirrors it — from the same seed and input log, and they have to land on the same
