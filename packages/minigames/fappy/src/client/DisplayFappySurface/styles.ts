...
// Marquee row (DESIGN.md §2.9): team left, show title centre, leg + gates + pending right.
...
export const resultPlaqueCrash = "border-text/25 shadow-[0_14px_32px_rgba(0,0,0,0.6)]";
