...
export const finishTime = "mt-1 block font-score tabular-nums text-lg text-text";

export const finishPoints = "mt-1 block font-score tabular-nums text-3xl font-black text-gold";
