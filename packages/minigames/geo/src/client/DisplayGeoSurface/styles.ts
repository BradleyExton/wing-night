...
export const plate = `${cornerStack} bottom-[clamp(1.4rem,3vh,3.2rem)] left-[clamp(1rem,2.4vw,2.6rem)] w-[clamp(17rem,30vw,34rem)] overflow-hidden rounded-2xl border border-text/15 bg-gradient-to-br from-surfaceAlt to-surface shadow-[0_26px_60px_theme(colors.shade/75%)]`;
