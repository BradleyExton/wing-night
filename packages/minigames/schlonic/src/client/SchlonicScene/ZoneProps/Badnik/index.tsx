...
import { OUTLINE_WIDTH, SchlongBody, resolveBadnikSkin } from "../SchlongBody/index.js";
...
export const Badnik = ({ prop }: { prop: SchlonicProp }): JSX.Element => {
  ...
  const skin = resolveBadnikSkin(prop.index);
  ...
  return (
    <g data-schlonic-badnik={prop.index}>
      ...
      <SchlongBody spine={spine} shaftRadius={SHAFT_RADIUS} headRadius={HEAD_RADIUS} skin={skin} veined />
