...
export const scene =
  "relative h-[min(100cqh,56.25cqw)] w-[min(100cqw,177.7778cqh)] overflow-hidden [container-type:size] [--schlonic-unit:0.625cqw] bg-[linear-gradient(180deg,#1f7fc4_0%,#6dc0ea_58%,#cfeaf7_100%)]";
