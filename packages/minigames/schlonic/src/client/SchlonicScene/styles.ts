...
// Morning sky over a green hill: the one minigame in the night that is supposed to read as a
// 16-bit platformer at a glance.
export const scene =
  "relative h-[min(100cqh,56.25cqw)] w-[min(100cqw,177.7778cqh)] overflow-hidden [container-type:size] [--schlonic-unit:0.625cqw] bg-[linear-gradient(180deg,#2aa7e0_0%,#7fd4f0_58%,#bdeafc_100%)]";
