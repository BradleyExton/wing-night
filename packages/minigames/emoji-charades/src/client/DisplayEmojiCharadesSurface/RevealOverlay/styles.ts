...
export const plaqueCorrect = `${plaqueBase} grid-cols-[auto_1fr_auto] border-[#5fe093] bg-gradient-to-b from-[#2a4d1f] to-[#0e2a14] shadow-[0_0_70px_rgba(47,184,108,0.4),0_14px_32px_rgba(0,0,0,0.6)]`;

export const plaqueSkipped = `${plaqueBase} grid-cols-[auto_1fr] border-[#ff8a8a] bg-gradient-to-b from-[#4d1f1f] to-[#2a0e0e] shadow-[0_0_70px_rgba(240,64,64,0.35),0_14px_32px_rgba(0,0,0,0.6)]`;

const verdictIconBase =
  "text-[clamp(2.8rem,4.4vw,4.4rem)] font-black leading-none";

export const verdictIconCorrect = `${verdictIconBase} text-[#2fb86c] [text-shadow:0_0_24px_rgba(47,184,108,0.6)]`;

export const verdictIconSkipped = `${verdictIconBase} text-[#ff8a8a] [text-shadow:0_0_24px_rgba(240,64,64,0.5)]`;

const labelBase =
  "mb-1.5 block text-[clamp(0.72rem,1vw,1rem)] font-extrabold uppercase tracking-[0.32em]";

export const labelCorrect = `${labelBase} text-[#2fb86c]`;

export const labelSkipped = `${labelBase} text-[#ff8a8a]`;
