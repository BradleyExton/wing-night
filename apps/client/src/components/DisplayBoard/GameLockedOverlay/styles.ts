export const overlay =
  "pointer-events-none fixed inset-0 z-30 flex flex-col items-center justify-center gap-[clamp(1.5rem,3vw,2.5rem)] bg-[theme(colors.shade/78%)] px-[clamp(1.5rem,3vw,3rem)] py-[clamp(1.5rem,3vw,3rem)] backdrop-blur-md";

export const lockFrame =
