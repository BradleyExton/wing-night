...
export const ambient =
  "pointer-events-none absolute inset-[-10%] bg-[radial-gradient(ellipse_at_20%_30%,theme(colors.gold/14%)_0%,transparent_45%),radial-gradient(ellipse_at_80%_70%,theme(colors.primary/12%)_0%,transparent_45%)]";
...
export const teamName =
  "m-0 text-[clamp(5rem,14vw,18rem)] font-black uppercase leading-[0.85] tracking-[-0.03em] text-gold [text-shadow:0_0_100px_theme(colors.gold/55%),0_0_240px_theme(colors.gold/30%)]";

export const teamWordmark = "text-[clamp(5rem,14vw,18rem)] leading-[0.85]";
