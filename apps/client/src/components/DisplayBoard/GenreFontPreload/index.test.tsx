...
test("does emit one font preload per genre face on the roster, plus the marquee's two", () => {
...
// The marquee wears Monoton and Anton on every game (DESIGN.md §2.2D), so a
// roster with no genres still preloads exactly those two and nothing else.
test("does emit only the marquee's faces when no team has a genre", () => {
