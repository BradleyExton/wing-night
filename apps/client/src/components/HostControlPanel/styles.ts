...
export const takeoverContainer = "min-h-[100dvh] overflow-hidden bg-bg text-text";

export const panel =
  "mx-auto w-full max-w-5xl rounded-xl border border-text/10 bg-surface p-6";

export const takeoverPanel =
  "mx-auto flex min-h-[100dvh] w-full max-w-none flex-col overflow-hidden bg-surface p-4 md:p-6";
