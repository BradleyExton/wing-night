  ...
  meta: {
    ...
    messages: {
      noNonsemanticColorToken:
        "Use semantic Wing Night color tokens in styles.ts (bg, surface, surfaceAlt, text, muted, mutedWarm, mutedWarmDim, ember, glow, glowHot, hearthGlass, shade, primary, heat, success, danger, gold, teamA-teamH) instead of raw Tailwind palette colors."
    }
  },
  create(context) {
