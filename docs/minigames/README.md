...
| Emoji Charades | spec | ready | [emoji-charades-spec.md](emoji-charades-spec.md) (+ [mockups](../../apps/client/public/mockups/emoji-charades-host/); direction picked — see DESIGN.md §2.6) |
